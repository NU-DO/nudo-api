...
// router.post('/song/:id/delete', authMiddleware.isAuthenticated, songController.delete)
...
router.post('/image/:id/delete', authMiddleware.isAuthenticated, imageController.delete)
...
// router.post('/contact/:id/delete', authMiddleware.isAuthenticated, contatcController.delete)
...
// router.post('/event/:id/delete', authMiddleware.isAuthenticated, eventController.delete)
...
// router.post('/location/:id/delete', authMiddleware.isAuthenticated, locationController.delete)
...
// router.post('/appointment/:id/delete', authMiddleware.isAuthenticated, appointmentController.delete)
