...
const platlistController = require('../controllers/playlist.controller')
...
router.get('/song', authMiddleware.isAuthenticated, platlistController.getSongs)
router.post('/song/new', authMiddleware.isAuthenticated, platlistController.create)
router.patch('/song/:id/edit', authMiddleware.isAuthenticated, platlistController.edit)
router.delete('/song/:id/delete', authMiddleware.isAuthenticated, platlistController.delete)
