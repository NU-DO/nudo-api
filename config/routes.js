...
router.get('/contacts', authMiddleware.isAuthenticated, contactController.getContacts)
...
router.get('/appointments', authMiddleware.isAuthenticated, appointmentController.getAppointments)
